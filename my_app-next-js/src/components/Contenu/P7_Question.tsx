                    ...
                    <div className="space-y-2 mt-6 w-full sm:w-[500px]">
                        ...
                        {questions.map((question) => (
                            ...
                            <button className="flex justify-between items-center bg-white hover:bg-gray-100 px-4 py-3 w-full font-medium text-gray-800 text-sm md:text-lg text-left  cursor-pointer"
                                ...
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className={`${openId === question.id ? "rotate-180" : "rotate-0"}transition-transform duration-300 text-[#6F7580] text-[16px] md:text-[14px]`} height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"></path></svg>
                            </button>
                            {openId === question.id && (
