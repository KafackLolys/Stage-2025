    ...
    return (
        <div className="text-center relative">
            ...
            <div className="relative max-w-[1232px] mx-auto overflow-hidden mt-10">
                ...
                >
                    {slides.map(slide => (
                        <div key={slide.id} className="sm:w-[80vw] min-w-[344px] flex items-center justify-center h-[379px]">
                ...
                <button
                    ...
                    className="absolute top-1/2 left-2 transform -translate-y-1/2 rounded-full z-20"
                >
                    <img alt="Previous" loading="lazy" width="40" height="40" decoding="async" data-nimg="1" className="rotate-180" src="images/arrowL.webp" />
                </button>
                <button
                    onClick={goNext}
                    aria-label="Suivant"
                    className="absolute top-1/2 right-2 transform -translate-y-1/2 rounded-full z-20"
                >
                    <img alt="Next" loading="lazy" width="40" height="40" decoding="async" data-nimg="1" src="images/arrowL.webp" />
                </button>
            </div>
        </div>
    );
