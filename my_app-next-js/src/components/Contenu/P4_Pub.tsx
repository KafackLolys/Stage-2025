...
const P4_Pub = () => {
    ...
    <div className="mb-8 relative min-h-[500px] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
        <p className="text-[16px] sm:text-[28px] md:text-[36px] font-semibold text-[#000000] z-30">
            En quelques minutes, transformez votre message en un
            <br />acte concret et rejoignez le mouvement EazyCause.
        </p>
        <p className="text-[66px] sm:text-[140px] font-medium text-black  tracking-[-6.65px] leading-[166.33px] z-30">+ 5.000</p>
        <p className="text-[26px]  sm:text-[33px] font-semibold text-black mt-2 z-30">Nous ont déjà rejoints</p>
        <a className="mt-4 sm:mt-6 text-[16px] sm:text-[14px] cursor-pointer bg-black text-white px-4 sm:px-6 py-2 sm:py-3 rounded-[14px] shadow-lg hover:bg-gray-800 transition-colors z-30" href="/login">Créer ma campagne maintenant !</a>
