...
const Bouton = () => {
    ...
    return (
        <div className="">
            ...
            <a className="ml-4 rounded-[12px] border border-black px-4 py-2 text-sm font-medium text-black hover:bg-blue-300 hover:border-blue-300 transition-colors" href="">
                Connexion
            </a>
        </div>
    );
