        ...
        <div className="relative inline-block text-left group ">
            <div>
                <button
                    ...
                    className="flex justify-between w-full rounded-md border-0 h-10 px-1 hover:text-[#1199ff]"
                >
                    <div className='flex items-center px-2 transition cursor-pointer'>
                        <span className='pr-1'>Causes</span>
            ...
            {isOpen && (
                <div
                    onMouseEnter={() => setIsOpen(true)}
                    onMouseLeave={() => setIsOpen(false)}
                    className="absolute leading-0 z-10 mt-1  w-52 rounded-md bg-white shadow-sm"
                >
                    <div className="py-1 px-2" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Éducation</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Humanitaire</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Politique</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Environnement</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Artiste</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Business</span>
                            </div>
                        </a>
                        <a href="#" className="rounded-b-md flex py-2 text-sm text-gray-700 hover:text-[#1199ff] hover:bg-gray-100" role="menuitem">
                            <div className='w-full hover:bg-gray-50 px-2 transition cursor-pointer'>
                                <span className='pr-1'>Autres</span>
                            </div>
                        </a>
                    </div>
                </div>
