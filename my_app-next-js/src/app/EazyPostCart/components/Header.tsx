        ...
        <header className={`${styles.couleurFond} shadow ${isFixed ? 'fixed top-0 z-30' : 'relative'} w-full`}>
            <nav className='w-full xl:flex hidden justify-between items-center py-4 px-[5%]'>
                ...
                <div className='flex items-center gap-x-6'>
                    ...
                    <button type='button' className='cursor-pointer rounded-xl border border-[#0A7CCE] text-[#0A7CCE] py-2 px-6 hover:bg-[#0A7CCE] hover:text-white transition duration-300'>Se connecter</button>
                </div>
            </nav>
